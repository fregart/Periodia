  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">      
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light" data-target="page_inventory"><div class="sidebar-icon"><i class="fas fa-tools"></i></div> Inventarier</a>           
