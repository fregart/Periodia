...
if ($count > 0) {
    while ($row = mysqli_fetch_array($result)) {            
        echo "<tr>";        
        echo "<td scope='col' class='h5' style='border-left:1rem solid #" . $row["st_hex"] . ";'><div class='list-project'><a href='#' class='text-dark' myID='" . $row["pr_ID"] . "'>" . ucfirst($row["pr_name"]) . "</a></div></td>";        
