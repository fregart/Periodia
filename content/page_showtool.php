    ...
    while($row = mysqli_fetch_array($result)) {
        echo "<div class='card'>";
            echo "<div class='card-body'>";
                ...
                echo "<hr>";
                echo "<div class='row'><div class='col-sm-6 col-lg-4'>Beskrivning </div><div class='col-sm-6 col-lg-4'>" . $row['to_description'] . "<div class='col-auto'></div></div></div>";                    
                ...
                <div class='form-group'>
                    <div class='row'>
                        ...
                        if ($_SESSION['user_role'] == 2) {
                            echo "<div class='col'>";
                            echo "<button class='btn btn-success' id='btn-edit-tool' maid='" . $row['to_ID'] . "' title='Redigera'>Redigera</button>";
                            echo "</div>";
                        }
                    echo "
                    </div>
