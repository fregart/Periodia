        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAnst-ID" name="inputAnst-ID" value="<?php echo $row['us_employeenr'] ?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputLname" name="inputLname" value="<?php echo $row['us_lname'] ?>">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputAddress2" name="inputAddress2" placeholder="Co" value="<?php echo $row['us_address2'] ?>">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-2">
                        <label for="inputZip">Postnr</label>
                        <input type="text" class="form-control" id="inputZip" name="inputZip" placeholder="123 45" value="<?php echo $row['us_zip'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputCity">Stad</label>
                        <input type="text" class="form-control" id="inputCity" name="inputCity" placeholder="Storstad" value="<?php echo $row['us_city'] ?>">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputPhone1" name="inputPhone1" value="<?php echo $row['us_phone1'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPhone2">Telefon 2</label>
                        <input type="text" class="form-control" id="inputPhone2" name="inputPhone2" value="<?php echo $row['us_phone2'] ?>">
                    </div>
                </div>
