    ...
    <div class="row">
        <div class="col-sm">
            ...
            <div class="alert alert-secondary" role="alert">
                Här visas tid som rapporterats in. Klicka på en rad för att ändra eller ta bort.
            </div>
...
<script>
    ...
    var $file = 'page_myhours_absence' + '.php?setYear='+ $cyear +'&setMonth=' + $cmonth;
    var $path = 'content/';
    ...
    $('tr.absenceDiv').click(function (e) {
        e.preventDefault();   
        e.stopPropagation();              
        var $cid = this.id;
        var $file = 'page_updateabsence' + '.php?setAbsenceID=' + $cid;
        var $path = 'content/';           
