            ...
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <div class="row w-50">
                        <div class="form-group">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="datumInput" name="datumInput"
                                    value="<?php echo $row['wo_date']; ?>" />
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="projekInput">Projekt</label>
                                <!--<i class="far fa-question-circle small"></i>-->
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" id="tidfrånInput" name="tidfrånInput"
                                    value="<?php echo $row['wo_starttime']; ?>" />
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="tidtillInput">Till</label>
                                <input type="time" class="form-control" id="tidtillInput" name="tidtillInput"
                                    value="<?php echo $row['wo_endtime']; ?>" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" id="rastInput" name="rastInput"
                                    value="<?php echo $row['wo_rest']; ?>" />
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="calcInput">Timmar</label>
                                <input type="text" class="form-control font-weight-bold text-success" id="calcInput"
                                    name="calcInput" value="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="notesInput"
                                    rows="5"><?php echo $row['wo_notes']; ?></textarea>
                            </div>
                        </div>
                    </div>
