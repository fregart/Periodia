...
<div class="container mt-4">
    <div class="row">
        <div class="col-sm">
            ...
            <p class="h4">Lägg till nytt verktyg</p>
            <br />


            <div class="col-lg-8 pb-5 card p-4" style="background-color:#dfe5e8;">
                <form method="POST" class="row">
                <input type="hidden" name="action" value="newTool">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="toolnameInput">Namn</label>
                            <input class="form-control" type="text" id="toolnameInput" name="toolnameInput" value="" required="">
                        </div>
                    </div>
