...
<div class="container mt-4">
    <div class="row">
        <div class="col-sm">
            ...
            <p class="h4">Lägg till ny maskin</p>
            <br />


            <div class="col-lg-8 pb-5 card p-4" style="background-color:#dfe5e8;">
                <form method="POST" class="row">
                <input type="hidden" name="action" value="newMachine">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="machinenameInput">Namn</label>
                            <input class="form-control" type="text" id="machinenameInput" name="machinenameInput" value="" required="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" id="hoursInput" name="hoursInput" value="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
